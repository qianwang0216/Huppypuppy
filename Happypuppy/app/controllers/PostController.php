...
class PostController extends BaseController
{
    ...
    public function listPost()
    {
        ...
        //$posts = Post::where('idUser','=',Session::get('userid'))->orderBy('idPosts', 'desc')->paginate(10);
        //$this->layout->title = 'Post listings';
        //$this->layout->main = View::make('dash')->nest('content', 'posts.list', compact('posts'));
        return View::make('dash')->nest('content', 'posts.list', compact('posts'));
    }
    ...
    public function showPost(Post $post)
    {
        ...
        return View::make('dash')->nest('content', 'posts.single', compact('post', 'comments'));
    }
    ...
    public function newPost()
    {
        ...
        return View::make('dash')->nest('content', 'posts.new');
    }
    ...
    public function editPost(Post $post)
    {
        ...
        return View::make('dash')->nest('content', 'posts.edit', compact('post'));
    ...
    public function savePost()
    {
        ...
        if ($valid->passes()) {
            ...
            $post->read_more = (strlen($post->content) > 600) ? substr($post->content, 0, 600) : $post->content;
            $post->save();
